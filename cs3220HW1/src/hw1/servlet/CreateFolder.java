...
public class CreateFolder extends HttpServlet {
   ...
   @SuppressWarnings("unchecked")
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		        ...
		        out.println( "<form action='CreateFolder' method='post'>" );
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Folder entry = new Folder( idSeed++, name, parentid );
	    ...
	    entries.add( entry );
	        ...
	        //For some reason everytime i create a folder it always goes to the main folder. when ever i try to find the id
	        //of the parent folder it always gives me null
